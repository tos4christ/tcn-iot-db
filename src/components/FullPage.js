...
import Modal from "./Modal";
 ...
 class FullPage extends React.Component {
   ...
   componentDidMount() {
    if(this.props.history.location.pathname === "/nisonaspage" || this.props.history.location.pathname === "/secure_nisonaspage") {
          ...
          <div className="ncc-display-div">
            ...
            <table className="ncc-tg">
              ...
              <tbody>
                ...
                <tr onClick={(e) => { this.setModalTrue(e, ['KAINJI (HYDRO)', this.state.kainjiPs]); }}>
                  <td>25</td>
                  <td>KAINJI (HYDRO)</td>
