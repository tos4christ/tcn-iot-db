...
class GeneratorApp extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      okpai_1: {
        id: "okpai_1",
        units: [ {id: "gt11", pd: {mw:0, a: 0, v: 0, mx: 0, f: 0, pf: 0}}, 
                 {id: "gt12", pd: {mw:0, a: 0, v: 0, mx: 0, f: 0, pf: 0}},]
      },
      okpai_2: {
        id: "okpai_2",
      ...
      zungeru: {
        id: "zungeru",
        units: [ {id: "g1", pd: {mw:0, a: 0, v: 0, mx: 0, f: 0, pf: 0}}, 
                 {id: "g2", pd: {mw:0, a: 0, v: 0, mx: 0, f: 0, pf: 0}},
                 {id: "g3", pd: {mw:0, a: 0, v: 0, mx: 0, f: 0, pf: 0}},
                 {id: "g4", pd: {mw:0, a: 0, v: 0, mx: 0, f: 0, pf: 0}},]
      },
      kainjiPs: {
        id: "kainjiPs",
      ...
      geometricPlant2: {
        id: "geometricPlant2",
        units: [ {id: "gt2", pd: {mw:0, a: 0, v: 0, mx: 0, f: 0, pf: 0}}]
      },
      geometricPlant3: {
        id: "geometricPlant3",
        units: [ {id: "gt3", pd: {mw:0, a: 0, v: 0, mx: 0, f: 0, pf: 0}}]
      },
      ibom: {
        id: "ibom power",
        units: [ {id: "gt3", pd: {mw:0, a: 0, v: 0, mx: 0, f: 0, pf: 0}}]
  ...
  render() {
    ...
    try {
      ...
      const { selectedStation, egbinPs, "sapele-gas": sapeleGas, delta2, delta3, afamVIPs, dadinkowa, okpai_1, okpai_2, 
        ...
        afamIIIPs: afam_3_Ps, paras_1, paras_2, shiroroPs, geometricPlant2, geometricPlant3, ibom } = this.state;
      ...
      const real_stations = [ibom, egbinPs, sapeleGas, delta2, delta3, delta4_2, delta4_1, afam_3_5_Ps, afamVIPs, dadinkowa, okpai_1, okpai_2, paras_1, paras_2, shiroroPs, zungeru, kainjiPs, jebbaPs, geometric_power];
