export default (state_data) => {
    ...
    const egbinPs_st1 = state_data.egbinPs.lines ? this.state.egbinPs.lines.filter(line => line.id === "st1").td : {mw: null, V: null};
    const egbinPs_st2 = state_data.egbinPs.lines ? this.state.egbinPs.lines.filter(line => line.id === "st2").td : {mw: null, V: null};
    const egbinPs_st3 = state_data.egbinPs.lines ? this.state.egbinPs.lines.filter(line => line.id === "st3").td : {mw: null, V: null};
    const egbinPs_st4 = state_data.egbinPs.lines ? this.state.egbinPs.lines.filter(line => line.id === "st4").td : {mw: null, V: null};
    const egbinPs_st5 = state_data.egbinPs.lines ? this.state.egbinPs.lines.filter(line => line.id === "st5").td : {mw: null, V: null};
    const egbinPs_st6 = state_data.egbinPs.lines ? this.state.egbinPs.lines.filter(line => line.id === "st6").td : {mw: null, V: null};
    const shiroroPs_411g1 = state_data.shiroroPs.lines ? this.state.shiroroPs.lines.filter(line => line.id === "411g1").td : {mw: null, V: null};
    const shiroroPs_411g2 = state_data.shiroroPs.lines ? this.state.shiroroPs.lines.filter(line => line.id === "411g2").td : {mw: null, V: null};
    const shiroroPs_411g3 = state_data.shiroroPs.lines ? this.state.shiroroPs.lines.filter(line => line.id === "411g3").td : {mw: null, V: null};
    const shiroroPs_411g4 = state_data.shiroroPs.lines ? this.state.shiroroPs.lines.filter(line => line.id === "411g4").td : {mw: null, V: null};
    const afamIv_vPs_gt17 = state_data.afamIv_vPs.lines ? this.state.afamIv_vPs.lines.filter(line => line.id === "gt17").td : {mw: null, V: null};
    const afamIv_vPs_gt18 = state_data.afamIv_vPs.lines ? this.state.afamIv_vPs.lines.filter(line => line.id === "gt18").td : {mw: null, V: null};
    const omotosho1_tr1 = state_data.omotosho1.lines ? this.state.omotosho1.lines.filter(line => line.id === "tr1").td : {mw: null, V: null};
    const omotosho1_tr2 = state_data.omotosho1.lines ? this.state.omotosho1.lines.filter(line => line.id === "tr2").td : {mw: null, V: null};
    const omotosho2_tr3 = state_data.omotosho2.lines ? this.state.omotosho2.lines.filter(line => line.id === "tr3").td : {mw: null, V: null};
    const omotosho2_tr4 = state_data.omotosho2.lines ? this.state.omotosho2.lines.filter(line => line.id === "tr4").td : {mw: null, V: null};
    ...
    const omotoshoNippPs_tr1 = state_data.omotoshoNippPs.lines ? this.state.omotoshoNippPs.lines.filter(line => line.id === "tr1").td : {mw: null, V: null};
    const omotoshoNippPs_tr2 = state_data.omotoshoNippPs.lines ? this.state.omotoshoNippPs.lines.filter(line => line.id === "tr2").td : {mw: null, V: null};
    const omotoshoNippPs_tr3 = state_data.omotoshoNippPs.lines ? this.state.omotoshoNippPs.lines.filter(line => line.id === "tr3").td : {mw: null, V: null};
    const omotoshoNippPs_tr4 = state_data.omotoshoNippPs.lines ? this.state.omotoshoNippPs.lines.filter(line => line.id === "tr4").td : {mw: null, V: null};
    const sapeleNippPs_st1 = state_data.sapeleNippPs.lines ? this.state.sapeleNippPs.lines.filter(line => line.id === "st1").td : {mw: null, V: null};
    const sapeleNippPs_st3 = state_data.sapeleNippPs.lines ? this.state.sapeleNippPs.lines.filter(line => line.id === "st3").td : {mw: null, V: null};
    const sapeleNippPs_gt1 = state_data.sapeleNippPs.lines ? this.state.sapeleNippPs.lines.filter(line => line.id === "gt1").td : {mw: null, V: null};
    const sapeleNippPs_gt2 = state_data.sapeleNippPs.lines ? this.state.sapeleNippPs.lines.filter(line => line.id === "gt2").td : {mw: null, V: null};
    const sapeleNippPs_gt3 = state_data.sapeleNippPs.lines ? this.state.sapeleNippPs.lines.filter(line => line.id === "gt3").td : {mw: null, V: null};
    const sapeleNippPs_gt4 = state_data.sapeleNippPs.lines ? this.state.sapeleNippPs.lines.filter(line => line.id === "gt4").td : {mw: null, V: null};
    const omokuPs1_o1r = state_data.omokuPs1.lines ? this.state.omokuPs1.lines.filter(line => line.id === "o1r").td : {mw: null, V: null};
    const riversIppPs_gt1 = state_data.riversIppPs.lines ? this.state.riversIppPs.lines.filter(line => line.id === "gt1").td : {mw: null, V: null};
    ...
    const gereguPs_r1j = state_data.gereguPs.lines ? this.state.gereguPs.lines.filter(line => line.id === "r1j").td : {mw: null, V: null};
    const gereguPs_r2j = state_data.gereguPs.lines ? this.state.gereguPs.lines.filter(line => line.id === "r2j").td : {mw: null, V: null};
    const gereguPs_gt11 = state_data.gereguPs.lines ? this.state.gereguPs.lines.filter(line => line.id === "gt11").td : {mw: null, V: null};
    const gereguPs_gt12 = state_data.gereguPs.lines ? this.state.gereguPs.lines.filter(line => line.id === "gt12").td : {mw: null, V: null};
    const gereguPs_gt13 = state_data.gereguPs.lines ? this.state.gereguPs.lines.filter(line => line.id === "gt13").td : {mw: null, V: null};    
    const delta3_tr5 = state_data.delta3.lines ? this.state.delta3.lines.filter(line => line.id === "tr5").td : {mw: null, V: null};
    const delta3_tr6 = state_data.delta3.lines ? this.state.delta3.lines.filter(line => line.id === "tr6").td : {mw: null, V: null};
    const delta2_tr3 = state_data.delta2.lines ? this.state.delta2.lines.filter(line => line.id === "tr3").td : {mw: null, V: null};
    const delta2_tr4 = state_data.delta2.lines ? this.state.delta2.lines.filter(line => line.id === "tr4").td : {mw: null, V: null};
    const olorunsogo1_tr1 = state_data.olorunsogo1.lines ? this.state.olorunsogo1.lines.filter(line => line.id === "tr1").td : {mw: null, V: null};
    const olorunsogo1_tr2 = state_data.olorunsogo1.lines ? this.state.olorunsogo1.lines.filter(line => line.id === "tr2").td : {mw: null, V: null};
    const ihovborNippPs_ohl1 = state_data.ihovborNippPs.lines ? this.state.ihovborNippPs.lines.filter(line => line.id === "ohl1").td : {mw: null, V: null};
    const ihovborNippPs_ohl2 = state_data.ihovborNippPs.lines ? this.state.ihovborNippPs.lines.filter(line => line.id === "ohl2").td : {mw: null, V: null};
    const ihovborNippPs_gt1 = state_data.ihovborNippPs.lines ? this.state.ihovborNippPs.lines.filter(line => line.id === "gt1").td : {mw: null, V: null};
    const ihovborNippPs_gt2 = state_data.ihovborNippPs.lines ? this.state.ihovborNippPs.lines.filter(line => line.id === "gt2").td : {mw: null, V: null};
    const ihovborNippPs_gt3 = state_data.ihovborNippPs.lines ? this.state.ihovborNippPs.lines.filter(line => line.id === "gt3").td : {mw: null, V: null};
    const ihovborNippPs_gt4 = state_data.ihovborNippPs.lines ? this.state.ihovborNippPs.lines.filter(line => line.id === "gt4").td : {mw: null, V: null};
    const parasEnergyPs_132cb = state_data.parasEnergyPs.lines ? this.state.parasEnergyPs.lines.filter(line => line.id === "132cb").td : {mw: null, V: null};
    const olorunsogoPhase1Gs_r2a = state_data.olorunsogoPhase1Gs.lines ? this.state.olorunsogoPhase1Gs.lines.filter(line => line.id === "r2a").td : {mw: null, V: null};
    const olorunsogoPhase1Gs_r1w = state_data.olorunsogoPhase1Gs.lines ? this.state.olorunsogoPhase1Gs.lines.filter(line => line.id === "r1w").td : {mw: null, V: null};
    const olorunsogoPhase1Gs_tr3 = state_data.olorunsogoPhase1Gs.lines ? this.state.olorunsogoPhase1Gs.lines.filter(line => line.id === "tr3").td : {mw: null, V: null};
    const olorunsogoPhase1Gs_tr4 = state_data.olorunsogoPhase1Gs.lines ? this.state.olorunsogoPhase1Gs.lines.filter(line => line.id === "tr4").td : {mw: null, V: null};
    const gbarain_st1 = state_data.gbarain.lines ? this.state.gbarain.lines.filter(line => line.id === "st1").td : {mw: null, V: null};
    const gbarain_st2 = state_data.gbarain.lines ? this.state.gbarain.lines.filter(line => line.id === "st2").td : {mw: null, V: null};
